...
@Component({
  selector: 'app-user-jewellery',
  templateUrl: './user-jewellery.component.html',
  styleUrls: ['./user-jewellery.component.scss']
})
export class UserJewelleryComponent implements OnInit {
  cards = [];
  constructor() { }
