...
@Component({
  selector: 'app-user-fashion',
  templateUrl: './user-fashion.component.html',
  styleUrls: ['./user-fashion.component.scss']
})
export class UserFashionComponent implements OnInit {
  cards = [];
  constructor() { }
