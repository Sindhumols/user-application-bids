...
@Component({
  selector: 'app-user-stationary',
  templateUrl: './user-stationary.component.html',
  styleUrls: ['./user-stationary.component.scss']
})
export class UserStationaryComponent implements OnInit {
  cards = [];
  constructor() { }
