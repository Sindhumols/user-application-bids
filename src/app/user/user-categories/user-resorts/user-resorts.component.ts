...
@Component({
  selector: 'app-user-resorts',
  templateUrl: './user-resorts.component.html',
  styleUrls: ['./user-resorts.component.scss']
})
export class UserResortsComponent implements OnInit {
  cards = [];
  constructor() { }
