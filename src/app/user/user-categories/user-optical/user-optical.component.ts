...
@Component({
  selector: 'app-user-optical',
  templateUrl: './user-optical.component.html',
  styleUrls: ['./user-optical.component.scss']
})
export class UserOpticalComponent implements OnInit {
  cards = [];
  constructor() { }
