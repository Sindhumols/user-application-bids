...
@Component({
  selector: 'app-user-electricals',
  templateUrl: './user-electricals.component.html',
  styleUrls: ['./user-electricals.component.scss']
})
export class UserElectricalsComponent implements OnInit {
  cards = [];
  constructor() { }
