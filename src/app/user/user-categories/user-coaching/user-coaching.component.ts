...
@Component({
  selector: 'app-user-coaching',
  templateUrl: './user-coaching.component.html',
  styleUrls: ['./user-coaching.component.scss']
})
export class UserCoachingComponent implements OnInit {
  cards = [];
  constructor() { }
