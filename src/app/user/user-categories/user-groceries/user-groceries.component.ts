...
@Component({
  selector: 'app-user-groceries',
  templateUrl: './user-groceries.component.html',
  styleUrls: ['./user-groceries.component.scss']
})
export class UserGroceriesComponent implements OnInit {
  cards = [];
  constructor() { }
