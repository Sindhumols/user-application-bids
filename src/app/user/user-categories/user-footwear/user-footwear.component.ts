...
@Component({
  selector: 'app-user-footwear',
  templateUrl: './user-footwear.component.html',
  styleUrls: ['./user-footwear.component.scss']
})
export class UserFootwearComponent implements OnInit {
  cards = [];
  constructor() { }
