...
@Component({
  selector: 'app-user-homedecor',
  templateUrl: './user-homedecor.component.html',
  styleUrls: ['./user-homedecor.component.scss']
})
export class UserHomedecorComponent implements OnInit {
  cards = [];
  constructor() { }
