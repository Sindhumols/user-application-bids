...
@Component({
  selector: 'app-user-resturants',
  templateUrl: './user-resturants.component.html',
  styleUrls: ['./user-resturants.component.scss']
})
export class UserResturantsComponent implements OnInit {
  cards = [];
  constructor() { }
