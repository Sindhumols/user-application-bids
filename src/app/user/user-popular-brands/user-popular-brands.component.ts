...
@Component({
  selector: 'app-user-popular-brands',
  templateUrl: './user-popular-brands.component.html',
  styleUrls: ['./user-popular-brands.component.scss']
})
export class UserPopularBrandsComponent implements OnInit {
  cards = [];
  constructor() { }
