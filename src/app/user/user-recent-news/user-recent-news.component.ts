...
@Component({
  selector: 'app-user-recent-news',
  templateUrl: './user-recent-news.component.html',
  styleUrls: ['./user-recent-news.component.scss']
})
export class UserRecentNewsComponent implements OnInit {
  cards = [];
  news = [];
  constructor() { }
