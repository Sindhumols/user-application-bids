...
export class UserCouponsComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.avengers = [{ id: 1, naming: 'In Store', name:'Fashion', name1:'Gift & Party Stores', name2:'Kid Stores', name3:'Electronics & Accessories', name4:'Home & Appliances', num:'4',num1:'4', num2:'4', num3:'4', num4:'4' }, 
]; 
  }
