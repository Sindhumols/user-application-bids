...
@Component({
  selector: 'app-user-grocies',
  templateUrl: './user-grocies.component.html',
  styleUrls: ['./user-grocies.component.scss']
})
export class UserGrociesComponent implements OnInit {
