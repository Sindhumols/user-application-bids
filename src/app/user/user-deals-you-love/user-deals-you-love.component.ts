...
@Component({
  selector: 'app-user-deals-you-love',
  templateUrl: './user-deals-you-love.component.html',
  styleUrls: ['./user-deals-you-love.component.scss']
})
export class UserDealsYouLoveComponent implements OnInit {
  constructor() { }
  value = 'FIRST';
